      ...
      <div className="w-full h-screen p-8 bg-slate-50 shadow-lg rounded-lg">
        ...
        <div>
          <div className="space-y-4 text-sm sm:text-lg">
            <p>
              <spam>Name:</spam>
              <span className="sm:ps-4 ps-2 font-semibold">Estiak Ahmed</span>
            </p>
            <hr />
          </div>
          ...
          <div className="space-y-4 py-4 text-sm sm:text-lg">
            <p>
              ...
              <span className="sm:ps-4 ps-2 font-semibold">
                estiakahmed@gmail.com
              </span>
            </p>
            <hr />
          ...
          <div className="space-y-4 text-sm sm:text-lg">
            <p>
              ...
              <span className="sm:ps-4 ps-2 font-semibold">+880123456789</span>
            </p>
            <hr />
          </div>
          ...
          <div className="space-y-4 py-4">
            <div className="flex gap-8 sm:gap-24 text-sm sm:text-lg">
              <p>
                <spam>Division:</spam>
                <span className="sm:ps-4 ps-2 font-semibold">Dhaka</span>
              </p>
              <p>
                <spam>District:</spam>
                <span className="sm:ps-4 ps-2 font-semibold">Jamalpur</span>
              </p>
            </div>
            <hr />
          </div>
